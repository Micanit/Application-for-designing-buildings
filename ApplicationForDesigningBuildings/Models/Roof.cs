...
namespace ApplicationForDesigningBuildings
{
    internal class Roof
    {
        ...
        public Roof(string name, int _width, int _height, int _horizontalPosition, int _verticalPosition, int _strokeWidth, Color _elementColor, Color _interiorElementColor)
        {
            Name = _name;
            Width = _width;
            Height = _height;
