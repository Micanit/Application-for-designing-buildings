...
namespace ApplicationForDesigningBuildings
{
    internal class WindowCasement
    {
        ...
        public WindowCasement(string name, int _width, int _height, int _horizontalPosition, int _verticalPosition, int _widthCollider, int _heightCollider, int _strokeWidth, Color _elementColor)
        {
            Name = _name;
            Width = _width;
            Height = _height;
