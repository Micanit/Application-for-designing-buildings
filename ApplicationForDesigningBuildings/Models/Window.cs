...
namespace ApplicationForDesigningBuildings
{
    internal class Window
    {
        ...
        public Window(string name, int _width, int _height, int _horizontalPosition, int _verticalPosition, int _strokeWidth, Color _elementColor, Color _interiorElementColor)
        {
            Name = _name;
            Width = _width;
            Height = _height;
