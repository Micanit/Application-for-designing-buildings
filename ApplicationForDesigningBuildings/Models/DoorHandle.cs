...
namespace ApplicationForDesigningBuildings
{
    internal class DoorHandle
    {
        ...
        public DoorHandle(string name, int _width, int _height, int _horizontalPosition, int _verticalPosition, int _strokeWidth, Color _elementColor)
        {
            Name = _name;
            Width = _width;
            Height = _height;
